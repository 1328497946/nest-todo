...
export class AddMagneticChain1702710540408 implements MigrationInterface {
  name = 'AddMagneticChain1702710540408';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE INDEX idx_user_id ON \`user\` (user_id)`);
